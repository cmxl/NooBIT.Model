...
{
    public abstract class IncludeSpecification<TEntity, TResult> : Specification<TEntity, TResult>, IIncludeSpecification<TEntity, TResult> where TEntity : class, IEntity
    {
    ...
    public abstract class IncludeSpecification<TEntity> : IncludeSpecification<TEntity, TEntity>, IIncludeSpecification<TEntity> where TEntity : class, IEntity
    {
        public IncludeSpecification() : this(null)
        {
        }
